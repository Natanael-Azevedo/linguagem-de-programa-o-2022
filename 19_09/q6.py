...
A nota de um aluno é um número real e o número de faltas é um número inteiro. Cada valor será fornecido em uma linha separada. Veja os exemplos de entrada e saída a seguir.
...
nota = float(input())
faltas= int(input())
if nota>=7 and faltas<0:
    print("Aprovado")
elif nota<7 and nota>=5 and faltas<=20:
    print("Aprovado")
elif nota<5 and nota>=3 and faltas<=20:
    print("Recuperação")
elif nota<3:
    print("Reprovado")
