...
Assuma que o ônibus somente pode atravessar um sinal verde. Para atravessar um sinal, é necessário esperar todos os carros
na frente do ônibus atravessarem o sinal. Assuma que se um sinal está verde, sempre é possível passar por ele antes de ele fechar.
...
No exemplo acima, o primeiro sinal está verde, então o tempo gasto nele será somente o tempo de esperar os dois carros na frente do ônibus atravessarem o sinal (2 * 2 = 4 segundos). O segundo sinal está amarelo, então o tempo gasto nele será o tempo de esperar o sinal ficar vermelho, mais o tempo do sinal vermelho ficar verde, mais o tempo dos 3 carros na frente do ônibus passarem o sinal (1 + 5 + (2 * 3) = 12 segundos). O terceiro sinal está vermelho e o ônibus vai demorar apenas 5 segundos para atravessá-lo, já que não há nenhum carro na frente. No total, o ônibus vai demorar 4 + 12 + 5 = 21 segundos para atravessar todos dos sinais.
'''