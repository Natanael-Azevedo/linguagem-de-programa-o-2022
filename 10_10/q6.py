...
O seu programa deve ler um valor inteiro N e em seguida ler as informações de N partidas, onde os dados de cada partida serão fornecidos
em uma linha, separados por um espaço, seguindo o formato:
